 ...
 */
final class Version20191127173707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fuseauhoraire (id INT NOT NULL, fuseau VARCHAR(255) NOT NULL, utc VARCHAR(255) NOT NULL, ville_en VARCHAR(255) DEFAULT NULL, ville_fr VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
